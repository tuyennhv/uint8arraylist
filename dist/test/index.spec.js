...
describe('Uint8arrayList', () => {
    describe('constructor', () => {
        ...
        it('constructor accepts a Uint8Array', () => {
            const bl = new Uint8ArrayList(new Uint8Array([97, 98, 99]));
            expect(bl.length).to.equal(3);
            expect(toString(bl.slice(), 'ascii')).to.equal('abc');
        });
        it('constructor accepts multiple Uint8Arrays', () => {
            const bl = new Uint8ArrayList(new Uint8Array([97, 98, 99]), Uint8Array.from([100, 101, 102]), new Uint8Array([103, 104, 105]), new Uint8Array([106, 107, 108]), new Uint8Array([109, 110, 111, 112]), new Uint8Array([113, 114, 115, 116, 117]), new Uint8Array([118, 119, 120, 121, 122]));
    ...
    describe('get', () => {
        ...
        it('get returns bytes', () => {
            const bl = new Uint8ArrayList();
            bl.append(new Uint8Array([97, 98, 99]), Uint8Array.from([100, 101, 102]), new Uint8Array([103, 104, 105]), new Uint8Array([106, 107, 108]), new Uint8Array([109, 110, 111, 112]), new Uint8Array([113, 114, 115, 116, 117]), new Uint8Array([118, 119, 120, 121, 122]));
            expect(bl.length).to.equal(26);
    ...
    describe('prepend', () => {
        ...
        it('prepend accepts multiple Uint8Arrays', () => {
            const bl = new Uint8ArrayList();
            bl.prepend(new Uint8Array([97, 98, 99]), Uint8Array.from([100, 101, 102]), new Uint8Array([103, 104, 105]), new Uint8Array([106, 107, 108]), new Uint8Array([109, 110, 111, 112]), new Uint8Array([113, 114, 115, 116, 117]), new Uint8Array([118, 119, 120, 121, 122]));
            expect(bl.length).to.equal(26);
            expect(toString(bl.slice(), 'ascii')).to.equal('abcdefghijklmnopqrstuvwxyz');
        });
        it('only appends appendable values', () => {
    ...
    describe('equals', () => {
        ...
        it('should equal other list with same contents', () => {
            const listA = new Uint8ArrayList(Uint8Array.from([0, 1, 2, 3, 4, 5]), Uint8Array.from([0, 1, 2, 3, 4, 5]));
            const listB = new Uint8ArrayList(Uint8Array.from([0, 1, 2, 3, 4, 5]), Uint8Array.from([0, 1, 2, 3, 4, 5]));
        ...
        it('should not equal other list with different contents', () => {
            const listA = new Uint8ArrayList(Uint8Array.from([0, 1, 2, 3, 4, 5]), Uint8Array.from([0, 1, 2, 3, 4, 5]));
            const listB = new Uint8ArrayList(Uint8Array.from([0, 1, 2, 3, 4, 5]), Uint8Array.from([6, 7, 8, 9, 10, 11]));
        ...
        it('should not equal other list with different length', () => {
            const listA = new Uint8ArrayList(Uint8Array.from([0, 1, 2, 3, 4, 5]), Uint8Array.from([0, 1, 2, 3, 4, 5]));
            const listB = new Uint8ArrayList(Uint8Array.from([0, 1, 2, 3, 4, 5]));
